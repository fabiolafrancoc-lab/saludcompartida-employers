export const translations = {
  ...
  hero: {
    ...
    p2:      { es: 'Telemedicina 24/7, descuentos en farmacia, terapia y acompañamiento AI para su familia en México — desde $18/mes por empleado.', en: 'Telemedicine 24/7, pharmacy discounts, therapy, and AI companion for their family in Mexico — from $18/month per employee.' },
  ...
  how: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc:  { es: 'El empleado recibe su SC Employee ID y un enlace de activación. Con un clic, activa la cuenta de su familia en México.', en: 'The employee receives their SC Employee ID and an activation link. With one click, they activate their family\'s account in Mexico.' },
      },
      {
        n: '04',
        title: { es: 'Mides el impacto en tiempo real', en: 'Measure real-time impact' },
  ...
  benefits: {
    ...
    services: [
      ...
      { key: 'lupita',   label: { es: 'Lupita — AI Companion',   en: 'Lupita — AI Companion' }, desc: { es: 'Llamadas proactivas de acompañamiento emocional para adultos mayores. Basado en 16 códigos conductuales propietarios.', en: 'Proactive emotional support calls for seniors. Based on 16 proprietary behavioral codes.' }, stat: 'AI',   statLabel: { es: 'proactivo', en: 'proactive' } },
    ],
  ...
  about: {
    ...
    govEyebrow: { es: 'Comité de Gobierno',               en: 'Governance Committee' },
    govTitle:   { es: 'Las personas detrás del producto', en: 'The people behind the product' },
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: { es: 'Sí. El dashboard de saludcompartida.ai muestra en tiempo real: consultas de telemedicina, transacciones en farmacia, sesiones de terapia y llamadas de Lupita.',                                                                                                            en: 'Yes. The saludcompartida.ai dashboard shows in real time: telemedicine consultations, pharmacy transactions, therapy sessions, and Lupita calls.' },
      },
      {
